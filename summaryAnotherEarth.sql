...
(
select Summary from movies where url='another-earth'
)
));
...
copy ( select * from recommendationsbasedonsummaryfield) to '/home/pi/RSL/top50reco_summaryAnotherEarth.csv' with csv;
